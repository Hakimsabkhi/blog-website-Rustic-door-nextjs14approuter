        ...
        {blogs.map((blog, index) => (
          ...
          >
            ...
            <div className="flex flex-col gap-2 bg-white rounded-xl pl-4 pb-4">
              <span className="text-sm text-orange-300">{blog.Catégorie}</span>
              <div className="flex items-center">
                <h2 className="text-xl font-semibold text-black drop-shadow-xl mb-2">{blog.title}</h2>
              ...
              <div className="flex items-center gap-4 mb-4">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-gray-400">{blog.likes} likes</span>
                </div>
                <div className="flex items-center gap-2">
                  <AiOutlineComment className="text-[25px]" />
                  <span className="text-gray-400">{blog.comments} comments</span>
                </div>
              </div>
              <div className="flex items-center gap-2">
