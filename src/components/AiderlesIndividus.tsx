...
function AiderlesIndividus() {
  return (
    <section className="w-full py-8 flex justify-center items-center centred">
      <div className="w-4/5 flex flex-col lg:flex-row gap-x-64 gap-y-16 items-center">
    ...
    <div className="flex items-start sm:gap-8">
      <div className="text-indigo-600 py-8">
        <PhoneCall className="w-10 h-10" /> {/* Call icon */}
      </div>
      <div>
        <strong className="text-[20px] font-medium text-indigo-600">
