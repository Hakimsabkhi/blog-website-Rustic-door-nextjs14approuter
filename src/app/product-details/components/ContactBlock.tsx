      ...
      <div className='flex flex-col md:flex-row centred gap-12 items-center w-full'>
        ...
        <div className="flex flex-col gap-4 text-center md:text-left w-full md:w-1/2">
          ...
          <div className="flex gap-4 justify-center">
            <a
              href="#"
              className="inline-block flex-initial rounded-full bg-sky-500 px-10 py-3 text-sm font-medium text-white transition hover:bg-blue-400 focus:outline-none"
            >
              APPELLER NOUS!
            </a>
            <a
              href="#"
              className="rounded-full bg-white px-10 py-3 text-sm font-medium text-sky-500 transition hover:bg-blue-100 focus:outline-none border border-blue-400"
            >
              ESTIMATION GRATUITE !
            </a>
          </div>
