    ...
    <section className='w-[95%] sm:w-[95%] md:w-[80%] lg:w-[80%] xl:w-[80%] 2xl:w-[80%] mx-auto py-8'>
      ...
      <div className='flex flex-col justify-center gap-4'>
        ...
        {testimonials.map((testimonial, index) => (
          <blockquote
            key={index}
            className="flex flex-col md:flex-row items-center rounded-xl bg-white p-6 shadow-xl sm:p-8 hover:bg-primary hover:text-white transition duration-300 ease-in-out"
          >
            <img
              alt=""
            ...
            />
            <div>
              <p className="mb-4 text-gray-700 hover:text-white transition duration-300 ease-in-out text-center sm:text-center md:text-left">{testimonial.text}</p>
              <div className="flex items-center gap-4 hover:text-white transition duration-300 ease-in-out">
                <div>
                  <p className="mt-0.5 text-2xl font-bold text-gray-900 hover:text-white transition duration-300 ease-in-out">{testimonial.name}</p>
                  <span className='text-[10px] hover:text-white transition duration-300 ease-in-out'>Regional Mobility Manager</span>
                </div>
